...
class Particle(object):
    ...
    def add_forces(particle1,particle2):
        ...
        r = r_squared**0.5
        force_magnitude = (G * particle1.mass * particle2.mass) / r_squared 
...
def get_input():
    ...
    for event in pygame.event.get():
        if   event.type == QUIT: return False
            ...
            elif event.key == K_r: setup_particles() 
    return True
def move():
        ...
        for j in range(i+1,num_particles,1):
            ...
            if Particle.get_collided(p1,p2):
                ...
                new_particles.append(Particle(
                    [(p1.pos[0]*p1.mass+p2.pos[0]*p2.mass)/mass,(p1.pos[1]*p1.mass+p2.pos[1]*p2.mass)/mass], 
                    [mv_x/mass, mv_y/mass], 
                    mass
                ))
