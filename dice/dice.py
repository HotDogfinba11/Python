...
def login():
    ...
    while running:
            ...
            if(cmd == "user"):
                    ...
                    newusr = open("username.csv", "w")
                    newusr.write(new_usr)
                    newusr.close()

                    new_psw = input("New Password: ")
                    newpsw = open("password.csv", "w")
            ...
            if(cmd == "score"):
                score = open("score.csv","r")
                score = score.read()
                print(score)

            
            if(cmd == "run"):
                username = open("username.csv","r")
                usr_read = username.read()
                username.close()

                password = open("password.csv","r")
